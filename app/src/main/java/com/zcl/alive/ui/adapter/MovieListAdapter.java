...
public class MovieListAdapter extends RecyclerArrayAdapter<MovieInfo> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new MovieListViewHolder(parent);
    }

    class MovieListViewHolder extends BaseViewHolder<MovieInfo> {
        ImageView imgPicture;
        TextView tv_title;

        public MovieListViewHolder(ViewGroup parent) {
            super(parent, R.layout.item_related);
            imgPicture = $(R.id.img_movie);
